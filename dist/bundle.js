...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueTwig = __webpack_require__(79);
	...
	var _co = __webpack_require__(39);
	...
	_vue2.default.use(_vueTwig2.default, [{
	  key: 'dataTree',
	  //saveType:twig.saveType.sessionStorage,
	  dataFun: _regenerator2.default.mark(function dataFun(data) {
	    var re;
	    return _regenerator2.default.wrap(function dataFun$(_context) {
	      while (1) {
	  ...
	  key: 'storage',
	  saveType: _vueTwig2.default.saveType.localStorage,
	  dataFun: function () {
	  ...
	  key: 'session',
	  saveType: _vueTwig2.default.saveType.sessionStorage,
	  dataFun: function () {
	        ...
	        while (1) {
	          switch (_context3.prev = _context3.next) {
	            ...
	            case 3:
	              ...
	              return _context3.abrupt('return', re);
	...
	_vueTwig2.default.ready(function () {
	  window.appVue = new _vue2.default({
	    el: '#container',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sub = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] sub.vue: named exports in *.vue files are ignored.")}
